...
数千〜数万時間の学習が必要な既存手法と比較して、LLMの知識を活かすことで1/10以下の学習時間に抑えることが可能と見込まれるため。
...
視覚音声認識LLMの研究の一部を表にまとめました。VSRとAVSRのどちらもあります。⭐️マークが本日扱う論文です。

| 論文 | 公開年月 | 種類 | 特徴 |
|---|---|---|
| VSP-LLM⭐️ | 2024-05 | VSR |  |
| Personalized Lip Reading | 2025-01 | VSR | 自前のエンコーダーを話者別にLoRA可能に |
| VALLR | 2025-03 | VSR |  |
| Zero-AVSR⭐️ |  | AVSR |  |
| MMS-LLaMA |  | AVSR |  |
...
## References (Base Model, Datasets, Survey)
